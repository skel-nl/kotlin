...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(MISSING_DEPENDENCY_SUPERCLASS, "Cannot access superclass ''{0}'' of class ''{1}''. Check your module classpath for missing or conflicting dependencies", TO_STRING, TO_STRING);
