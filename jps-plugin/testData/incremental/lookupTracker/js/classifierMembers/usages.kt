...
/*p:foo*/fun usages(i: /*p:foo*/I) {
    ...
    /*p:foo*/A./*c:foo.A.Companion c:foo.A p:foo p:foo(invoke) p:bar p:bar(invoke)*/vala
    /*p:foo*/A./*c:foo.A c:foo.A.Companion p:foo p:foo(invoke) p:bar p:bar(invoke)*/vara()
    ...
    /*p:foo p:bar p:bar(invoke)*/E./*c:foo.E*/X
    /*p:foo p:bar p:bar(invoke) p:kotlin(Int)*/E./*c:foo.E*/X./*c:foo.E*/a
    /*p:foo p:bar p:bar(invoke)*/E./*c:foo.E*/Y./*c:foo.E*/foo()
    /*p:foo p:bar p:bar(invoke) p:kotlin(Array)*/E./*c:foo.E*/values()
    /*p:foo p:bar p:bar(invoke)*/E./*c:foo.E*/valueOf(/*p:kotlin(String)*/"")
    /*p:foo p:bar p:bar(invoke)*/E./*c:foo.E p:foo p:foo(invoke) p:bar p:bar(invoke)*/foo
    /*p:foo p:bar p:bar(invoke)*/E./*c:foo.E p:foo p:foo(invoke) p:bar p:bar(invoke)*/bar()
}
