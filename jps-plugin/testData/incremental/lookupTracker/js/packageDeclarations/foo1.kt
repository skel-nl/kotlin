...
/*p:foo*/var b: /*p:foo p:bar*/baz./*p:baz*/B = /*p:foo p:foo(invoke) p:bar p:baz(B)*/baz./*p:baz*/B()
...
/*p:foo*/fun /*p:foo*/MyClass.extFunc(p: /**p:foo p:bar*//*p:foo p:bar*/Array</*p:foo p:bar*/B>, e: /*p:foo*/MyEnum, c: /**???*//*p:baz*/C): /*p:foo*/MyInterface /*p:kotlin(Nothing)*/{
    /*c:foo.MyClass p:foo p:baz(B)*/b
    /*p:kotlin(Nothing)*/return /*c:foo.MyClass p:foo*/MyClass()
}
